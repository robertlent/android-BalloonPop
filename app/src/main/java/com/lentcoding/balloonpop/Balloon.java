...
import com.lentcoding.balloonpop.utils.PixelHelper;
...
public class Balloon extends ImageView implements ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener {
    ...
    public Balloon(Context context, int color, @SuppressWarnings("SameParameterValue") int rawHeight) {
        super(context);
    ...
    public void setPopped(@SuppressWarnings("SameParameterValue") boolean popped) {
        mPopped = popped;
